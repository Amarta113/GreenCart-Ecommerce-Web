        ...
        <div className='flex flex-col-reverse md:flex-row justify-between mt-10'>
            <div className='flex-1 max-w-md'>
                <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
                    ...
                    <InputField type="email" placeholder="Email address" name='email' handleChange={handleChange}
                        address={address}/>
                    <InputField type="text" placeholder="Street" name='street' handleChange={handleChange}
                        address={address}/>
                    <div className='grid grid-cols-2 gap-4'>
                        <InputField type="text" placeholder="City" name='city' handleChange={handleChange}
                        address={address}/>
                        <InputField type="text" placeholder="State" name='state' handleChange={handleChange}
                        address={address}/>
                    </div>
                    <div className='grid grid-cols-2 gap-4'>
                        <InputField type="number" placeholder="Zip code" name='zipcode' handleChange={handleChange}
                        address={address}/>
                        <InputField type="text" placeholder="Country" name='country' handleChange={handleChange}
                        address={address}/>
                    </div>
